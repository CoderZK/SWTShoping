...
@interface SWTMJMineBaoBiaoVC ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate>
...
@implementation SWTMJMineBaoBiaoVC
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    ...
    SWTMJMineBaoBiaoSubTVC *vc = [[SWTMJMineBaoBiaoSubTVC alloc] init];
    vc.type = index;
    return vc;
