...
@interface SWTMJMineJingPaiFatherVC ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate>
...
@implementation SWTMJMineJingPaiFatherVC
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    ...
    SWTMJMineJingPaiSubTVC *vc = [[SWTMJMineJingPaiSubTVC alloc] init];
