...
@interface SWTMineCollectFatherVC ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate,UIScrollViewDelegate>
...
@implementation SWTMineCollectFatherVC
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    ...
    SWTMineCollectVC * vc1 = [[SWTMineCollectVC alloc] init];
    vc1.type = index +1;
    return vc1;
