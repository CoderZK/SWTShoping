...
@interface SWTMineHeMaiOrderFatherVC ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate,UIScrollViewDelegate>
...
@implementation SWTMineHeMaiOrderFatherVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"我的合买";
    self.titleArr = @[@"待完成",@"已完成"];
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    SWTMineHeMaiOrderSubTVC * vc = [[SWTMineHeMaiOrderSubTVC alloc] init];
    vc.type = index + 1;
    return vc;
