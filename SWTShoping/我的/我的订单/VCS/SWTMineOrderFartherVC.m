...
@interface SWTMineOrderFartherVC ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate>
...
@implementation SWTMineOrderFartherVC
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    ...
    SWTMineOrderSubTVC *vc = [[SWTMineOrderSubTVC alloc] init];
