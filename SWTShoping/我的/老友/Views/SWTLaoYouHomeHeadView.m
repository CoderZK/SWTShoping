...
- (void)setDataDict:(NSDictionary *)dataDict {
    _dataDict = dataDict;
    if ([dataDict.allKeys containsObject:@"title"]) {
        self.lb1.text = dataDict[@"title"];
    }
    if ([dataDict.allKeys containsObject:@"content"]) {
           self.lb3.text = dataDict[@"content"];
       }
    
    if ([dataDict.allKeys containsObject:@"subtitle"]) {
        self.lb2.text = dataDict[@"subtitle"];
    }
}
