...
/** 每一行之间的间距 */
static const CGFloat XMGDefaultHeadHeight = 0;
...
- (CGFloat)height {
    if ([self.delegate respondsToSelector:@selector(collectionViewSectionHeadHeight:)]) {
        return [self.delegate collectionViewSectionHeadHeight:self];
    }
    
    return XMGDefaultHeadHeight;
